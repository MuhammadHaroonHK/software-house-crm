...
interface ContactPersonsHeaderProps {
  search: string;
  onSearchChange: (value: string) => void;
  onCreate: () => void;
}

export default function ContactPersonsHeader({
  search,
  onSearchChange,
  onCreate,
}: ContactPersonsHeaderProps) {
  return (
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            Manage the people associated with your clients.
          </p>
        </div>
